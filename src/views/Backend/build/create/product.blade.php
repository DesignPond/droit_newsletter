<form ng-controller="SelectController as select" class="row form-horizontal" name="arretForm" method="post" action="{{ url('build/content') }}">
    {{ csrf_field() }}
    <div class="col-md-7" id="StyleNewsletterCreate">
        <!-- Bloc content-->
        <table border="0" width="560" align="center" cellpadding="0" cellspacing="0" class="resetTable">
            <tr>
                <td valign="top" width="560" class="resetMarge contentForm">
